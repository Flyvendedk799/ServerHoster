              ...
              {source === "local" && scan && (
                <div className="scan-panel">
                  <div className="row between">
                    <div>
                      ...
                      <p className="muted small">
                        {scan.candidates.length} possible dev server{scan.candidates.length === 1 ? "" : "s"}{" "}
                        found.
                      </p>
                    </div>
                    <button
                  ...
                  {scan.warnings.map((warning) => (
                    <div key={warning} className="scan-warning">
                      {warning}
                    </div>
                  ))}
                ...
                <div className="scan-panel">
                  <div className="row">
                    ...
                    <div>
                      ...
                      <p className="muted small">
                        LocalSURV will clone the URL, detect the runtime, run the build pipeline, and register
                        the service.
                      </p>
                    </div>
                  </div>
              ...
              {tunnelUrl && (
                ...
                >
                  <div className="row between">
                    ...
                    <a href={tunnelUrl} target="_blank" rel="noreferrer" className="link font-bold">
                      {tunnelUrl}
                    </a>
                  </div>
                </div>
