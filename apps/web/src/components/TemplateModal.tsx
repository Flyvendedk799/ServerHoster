...
const TEMPLATES = [
  { id: "node-api", name: "Node.js API", description: "Express/Fastify starter with modular architecture.", icon: Braces },
  { id: "python-api", name: "Python API", description: "FastAPI starter with automated environment setup.", icon: Zap },
  { id: "static-site", name: "Static Web App", description: "Modern React/Vue/Vite frontend template.", icon: Globe2 }
];
          ...
          <div style={{ display: "grid", gap: "1rem" }}>
            {TEMPLATES.map((t) => {
              ...
              >
                ...
                {selected === t.id && <div className="check"><Check size={18} /></div>}
              </div>
            )})}
          </div>
        </div>
